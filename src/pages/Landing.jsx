...
const features = [
  { icon: 'ðŸ“Š', color: 'from-primary-400 to-primary-600',   title: 'Real-time Analytics',    desc: 'Beautiful charts and instant dashboards that update as you track.' },
  { icon: 'ðŸ“Ž', color: 'from-emerald-400 to-emerald-600',   title: 'Receipt Upload',          desc: 'Attach photos of receipts to any transaction via Cloudinary.' },
  { icon: 'ðŸ”’', color: 'from-purple-400 to-purple-600',     title: 'Secure & Private',        desc: 'Per-user Firestore isolation. Your data, only yours.' },
  { icon: 'ðŸ””', color: 'from-orange-400 to-orange-600',     title: 'Budget Alerts',           desc: 'Get notified before you overspend any category.' },
  { icon: 'ðŸ¤–', color: 'from-pink-400 to-rose-500',         title: 'AI Insights',             desc: 'Llama-powered analysis of your spending patterns.' },
  { icon: 'ðŸ”', color: 'from-cyan-400 to-cyan-600',         title: 'Recurring Transactions',  desc: 'Auto-apply monthly bills and subscriptions.' },
  { icon: 'ðŸŽ¯', color: 'from-amber-400 to-amber-600',       title: 'Savings Goals',           desc: 'Set targets and watch your progress bar grow.' },
  { icon: 'ðŸ“¤', color: 'from-indigo-400 to-indigo-600',     title: 'CSV Import',              desc: 'Bulk import transactions from any bank export.' },
]
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-950">
      ...
      <nav className="sticky top-0 z-20 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-gray-100 dark:border-gray-800 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 font-extrabold text-xl text-primary-600 dark:text-primary-400">
            <span className="text-3xl leading-none">ðŸ’°</span> MoneyMind
          </div>
      ...
      <section className="relative flex-1 flex flex-col items-center justify-center text-center px-4 py-28 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto animate-fadeIn">
          <div className="inline-flex items-center gap-2 bg-primary-100 dark:bg-primary-900/40 text-primary-700 dark:text-primary-400 text-xs font-bold px-4 py-1.5 rounded-full mb-6 uppercase tracking-widest">
            ðŸš€ Smart Personal Finance for Bangladesh
          </div>
          ...
          <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto text-balance leading-relaxed">
            Log income &amp; expenses in à§³ BDT, upload receipts, set budgets,
            and get AI-powered insights â€” all in one beautiful dashboard.
          </p>
        ...
        <div className="relative mt-20 max-w-4xl w-full mx-auto rounded-2xl shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-700 animate-slideUp">
          ...
          <div className="bg-white dark:bg-gray-900 p-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-4xl font-extrabold">à§³42,350.00</p>
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="bg-white/10 rounded-xl p-3">
                  <p className="text-emerald-200 text-[11px] font-bold uppercase tracking-wide mb-1">â†‘ Income</p>
                  <p className="font-bold text-lg">à§³75,000</p>
                </div>
                <div className="bg-white/10 rounded-xl p-3">
                  <p className="text-red-200 text-[11px] font-bold uppercase tracking-wide mb-1">â†“ Expenses</p>
                  <p className="font-bold text-lg">à§³32,650</p>
                </div>
              </div>
            </div>
            {['ðŸ” Food â€” à§³8,200', 'ðŸ  Rent â€” à§³15,000', 'ðŸš— Transport â€” à§³3,500'].map(t => (
      ...
      <footer className="bg-gray-950 text-gray-500 text-center py-6 text-sm">
        Â© {new Date().getFullYear()} MoneyMind. Built with â¤ï¸ using React, Firebase &amp; Cloudinary.
      </footer>
    </div>
  )
}
